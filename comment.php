...
echo "<form method='POST' action'".setComment($conn)."'  >
  <input type='hidden' name='UID' value='".$_SESSION['University_ID']."'>
  <input type='hidden' name='date' value='" .date('Y-m-d H:i:s')."'>
  <textarea name='message' placeholder='اكتب استفسارك هنا' dir='rtl'></textarea><br>
  <button class='butcom' type='submit' name='commentSubmit'> ارسال </button>
